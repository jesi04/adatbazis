...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Ápr 25. 12:46
...
INSERT INTO `bemutato` (`id`, `feladatid`, `fajlNeve`, `fajlTipusa`) VALUES
(1, 1, 'felhuzas', 'jpg'),
(2, 2, 'guggolas', 'mp4');
...
(1, 2, 0, '2022-02-09', '2022-04-23', 'Tömegelés'),
(2, 1, 70, '2020-02-12', '2022-06-17', 'Fogyás'),
(3, 3, 60, '2019-02-14', '2019-02-21', 'Fogyás'),
(4, 4, 95, '2022-02-01', '2022-03-18', 'Tömegelés'),
(5, 2, 0, '2022-02-09', '2022-04-23', 'Tömegelés'),
(6, 2, 0, '2022-02-09', '2022-04-23', 'Tömegelés'),
(7, 2, 100, '2022-02-09', '2022-04-23', 'Fogyás');
...
INSERT INTO `feladat` (`id`, `nev`, `elegetettKcal`, `leiras`, `megjegyzes`, `izomcsoport`) VALUES
...
(1, 'pelda20@gmail.com', 'Kiss János', '2018-02-15', 185, ''),
...
--
-- AUTO_INCREMENT a táblához `javasoltedzes`
--
ALTER TABLE `javasoltedzes`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
