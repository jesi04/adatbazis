...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Feb 21. 15:43
...
CREATE TABLE `bemutatok` (
  ...
  `fajl neve` varchar(255) NOT NULL,
  `fajl tipusa` char(3) NOT NULL
...
INSERT INTO `bemutatok` (`id`, `feladatid`, `fajl neve`, `fajl tipusa`) VALUES
(1, 1, 'felhuzas', 'jpg'),
(2, 2, 'guggolas', 'mp4');
...
(3, 3, 60, '2019-02-14', '2019-02-21', 'Nyomjad Kósa'),
(4, 4, 95, '2022-02-01', '2022-03-18', 'Nyomjad Kovács');
...
(1, 'pelda1@gmail.com', 'Kiss János', '2018-02-15', 185, ''),
(2, 'pelda2@gmail.com', 'Nagy Péter', '2003-07-15', 167, ''),
(3, 'pelda3@gmail.com', 'Kósa Erzsi', '2013-03-28', 193, 'Kósa'),
